...
\begin{problem}[Mandatory; No LLM; 15 pts]
    ...
    \begin{mathpar}
        ...
        \begin{array}{cc}
            ...
            {B \downarrow} \arcr
            & \vdots \arcr
            A \limpl B \downarrow \and A \uparrow &
            \inferrule*
            {}
            {C \uparrow}
        \end{array}    
...
\begin{mathpar}
    ...
    \begin{array}{ccccc}
        ...
        {A \downarrow} \arcr
        & & \vdots & & \vdots \arcr
        A \star B \downarrow & \quad A \uparrow &
        \inferrule*
        {}
        {C \uparrow}
        & B \uparrow
...
\begin{mathpar}
    ...
    {A \uparrow}
    {A \heartsuit B \Diamond C \uparrow}
    \and
    \inferrule*[right=$\heartsuit \Diamond I_2$]
    {B \uparrow \and C \uparrow}
    {A \heartsuit B \Diamond C \uparrow}
    \and
    ...
    \begin{array}{cccc}
        ...
        {A \downarrow} \arcr
        & \vdots & \vdots \arcr
        A \heartsuit B \Diamond C \downarrow &
        \inferrule*
        {}
        {D \uparrow} &
        & D \uparrow
...
\end{mathpar}
    \begin{itemize}
        \item Are the rules locally sound? If yes, show a reduction. Otherwise, give an explanation of unsoundness.
        \item Are the rules locally complete? If yes, show an expansion. Otherwise, give an explanation of incompleteness.
        \item Provide a derivation of $A \heartsuit B \Diamond C \limpl A \heartsuit C \Diamond B$.
    \end{itemize}
\end{problem}
